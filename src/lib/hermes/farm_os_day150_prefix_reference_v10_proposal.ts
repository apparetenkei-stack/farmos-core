...
export const FARM_OS_DAY150_PREFIX_REFERENCE_V10_APPROVAL_SCHEMA =
  "farmos.day150-prefix-reference-execution-approval-record.v2" as const;
export const FARM_OS_DAY150_PREFIX_REFERENCE_V10_APPROVAL_REVISION = 2 as const;
export const FARM_OS_DAY150_PREFIX_REFERENCE_V10_APPROVED_AT_REQUIREMENT =
  "<PRODUCT_OWNER_REQUIRED>" as const;
export const FARM_OS_DAY150_PREFIX_REFERENCE_V10_APPROVAL_RECORD_DIGEST_STATUS =
  "<PENDING_PRODUCT_OWNER_APPROVED_AT>" as const;

export const FARM_OS_DAY150_PREFIX_REFERENCE_V10_APPROVAL_RECORD_CANONICAL_FIELD_NAMES =
  Object.freeze([
...
export function createFarmOsDay150PrefixReferenceV10ProposalRequest(
  proposalCreatedAt: string,
) {
  const proposal = materializeFarmOsDay150PrefixReferenceExecutionProposal({
    candidate: FARM_OS_DAY150_PREFIX_REFERENCE_V10_APPROVAL_RECORD_CANDIDATE,
  ...
  return Object.freeze({
    authorization_request: FARM_OS_DAY150_PREFIX_REFERENCE_EXECUTION_AUTHORIZATION_V10_REQUEST,
    ...
    approval_record_canonical_fields_before_human_approval: Object.freeze({
      schema_version: FARM_OS_DAY150_PREFIX_REFERENCE_V10_APPROVAL_SCHEMA,
      approval_record_revision: FARM_OS_DAY150_PREFIX_REFERENCE_V10_APPROVAL_REVISION,
      ...candidateBindings,
      proposal_identity,
      proposal_created_at,
      approval_reference,
      approved_at: FARM_OS_DAY150_PREFIX_REFERENCE_V10_APPROVED_AT_REQUIREMENT,
    }),
    approval_record_digest: FARM_OS_DAY150_PREFIX_REFERENCE_V10_APPROVAL_RECORD_DIGEST_STATUS,
