...
export const FARM_OS_DAY150_PREFIX_REFERENCE_V11_APPROVAL_SCHEMA =
  "farmos.day150-prefix-reference-execution-approval-record.v2" as const;
export const FARM_OS_DAY150_PREFIX_REFERENCE_V11_APPROVAL_REVISION = 2 as const;
export const FARM_OS_DAY150_PREFIX_REFERENCE_V11_APPROVED_AT_REQUIREMENT =
  "<PRODUCT_OWNER_REQUIRED>" as const;
export const FARM_OS_DAY150_PREFIX_REFERENCE_V11_APPROVAL_RECORD_DIGEST_STATUS =
  "<PENDING_PRODUCT_OWNER_APPROVED_AT>" as const;

export const FARM_OS_DAY150_PREFIX_REFERENCE_V11_APPROVAL_RECORD_CANONICAL_FIELD_NAMES =
  Object.freeze([
...
export function createFarmOsDay150PrefixReferenceV11ProposalRequest(
