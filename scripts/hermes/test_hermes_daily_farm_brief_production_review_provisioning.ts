...
const ENV = {
  ...
  HERMES_DAILY_BRIEF_DATABASE_HOST: "daily-brief.fixture.invalid",
  HERMES_DAILY_BRIEF_DATABASE_PORT: "5432",
  HERMES_DAILY_BRIEF_DATABASE_NAME: "farmos_core_pilot",
  HERMES_DAILY_BRIEF_DATABASE_USER: "daily_brief_runtime_fixture",
  HERMES_DAILY_BRIEF_DATABASE_PASSWORD: "daily-brief-credential-fixture",
  ...
  HERMES_DAILY_FARM_BRIEF_PROPOSAL_REVIEW_DATABASE_HOST: "proposal-review.fixture.invalid",
  HERMES_DAILY_FARM_BRIEF_PROPOSAL_REVIEW_DATABASE_PORT: "5433",
  HERMES_DAILY_FARM_BRIEF_PROPOSAL_REVIEW_DATABASE_NAME: "farmos_core_local",
  HERMES_DAILY_FARM_BRIEF_PROPOSAL_REVIEW_DATABASE_USER: "proposal_review_runtime_fixture",
  HERMES_DAILY_FARM_BRIEF_PROPOSAL_REVIEW_DATABASE_PASSWORD: "proposal-review-credential-fixture",
  HERMES_DAILY_FARM_BRIEF_PROPOSAL_REVIEW_DATABASE_SSL_MODE: "verify-full",
  HERMES_DAILY_FARM_BRIEF_PROPOSAL_REVIEW_DATABASE_CONNECT_TIMEOUT_MS: "1000",
  HERMES_DAILY_FARM_BRIEF_PROPOSAL_REVIEW_DATABASE_STATEMENT_TIMEOUT_MS: "3000",
  ...
  HERMES_DAILY_FARM_BRIEF_PRIVILEGE_ADMIN_DATABASE_HOST: "proposal-review.fixture.invalid",
  HERMES_DAILY_FARM_BRIEF_PRIVILEGE_ADMIN_DATABASE_PORT: "5433",
  HERMES_DAILY_FARM_BRIEF_PRIVILEGE_ADMIN_DATABASE_NAME: "farmos_core_local",
...
assert.equal((await diagnoseDay130ProductionReviewProvisioning({
  ...ENV,
  HERMES_DAILY_FARM_BRIEF_PRIVILEGE_ADMIN_DATABASE_HOST: ENV.HERMES_DAILY_BRIEF_DATABASE_HOST,
  HERMES_DAILY_FARM_BRIEF_PRIVILEGE_ADMIN_DATABASE_PORT: ENV.HERMES_DAILY_BRIEF_DATABASE_PORT,
  HERMES_DAILY_FARM_BRIEF_PRIVILEGE_ADMIN_DATABASE_NAME: ENV.HERMES_DAILY_BRIEF_DATABASE_NAME,
})).state, "target_mismatch", "admin matching only Daily Brief must not be accepted");
assert.equal((await diagnoseDay130ProductionReviewProvisioning(Object.fromEntries(
...
for (const forbidden of [
  ...
  ENV.HERMES_DAILY_FARM_BRIEF_PROPOSAL_REVIEW_DATABASE_NAME,
  ENV.HERMES_DAILY_FARM_BRIEF_PROPOSAL_REVIEW_DATABASE_HOST,
  ENV.HERMES_DAILY_FARM_BRIEF_PROPOSAL_REVIEW_DATABASE_USER,
  ENV.HERMES_DAILY_FARM_BRIEF_PROPOSAL_REVIEW_DATABASE_PASSWORD,
