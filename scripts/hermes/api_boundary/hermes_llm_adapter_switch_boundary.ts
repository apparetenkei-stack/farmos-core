...
export const hermesBusinessPromptConfirmationTokenIssuanceOperationPlanProviderAliases =
  [
...
export type HermesBusinessPromptConfirmationTokenIssuanceOperationPlanProviderAlias =
  (typeof hermesBusinessPromptConfirmationTokenIssuanceOperationPlanProviderAliases)[number];

export function isHermesBusinessPromptConfirmationTokenIssuanceOperationPlanProviderAlias(
  provider: string,
): provider is HermesBusinessPromptConfirmationTokenIssuanceOperationPlanProviderAlias {
  return (
    hermesBusinessPromptConfirmationTokenIssuanceOperationPlanProviderAliases as readonly string[]
  ).includes(provider);
}

export const hermesBusinessPromptConfirmationTokenIssuanceExecutionGateProviderAliases =
  [
...
export type HermesBusinessPromptConfirmationTokenIssuanceExecutionGateProviderAlias =
  (typeof hermesBusinessPromptConfirmationTokenIssuanceExecutionGateProviderAliases)[number];

export function isHermesBusinessPromptConfirmationTokenIssuanceExecutionGateProviderAlias(
  provider: string | undefined,
): provider is HermesBusinessPromptConfirmationTokenIssuanceExecutionGateProviderAlias {
  return hermesBusinessPromptConfirmationTokenIssuanceExecutionGateProviderAliases.includes(
...
export const hermesBusinessPromptConfirmationTokenIssuanceExecutionRequestEnvelopeProviderAliases =
  [
...
export type HermesBusinessPromptConfirmationTokenIssuanceExecutionRequestEnvelopeProviderAlias =
  (typeof hermesBusinessPromptConfirmationTokenIssuanceExecutionRequestEnvelopeProviderAliases)[number];

export function isHermesBusinessPromptConfirmationTokenIssuanceExecutionRequestEnvelopeProviderAlias(
  provider: string | undefined,
): provider is HermesBusinessPromptConfirmationTokenIssuanceExecutionRequestEnvelopeProviderAlias {
  return hermesBusinessPromptConfirmationTokenIssuanceExecutionRequestEnvelopeProviderAliases.includes(
    provider as HermesBusinessPromptConfirmationTokenIssuanceExecutionRequestEnvelopeProviderAlias,
  );
}

export const hermesBusinessPromptConfirmationTokenIssuanceExecutionResultPlanProviderAliases =
  [
...
export type HermesBusinessPromptConfirmationTokenIssuanceExecutionResultPlanProviderAlias =
  (typeof hermesBusinessPromptConfirmationTokenIssuanceExecutionResultPlanProviderAliases)[number];

export function isHermesBusinessPromptConfirmationTokenIssuanceExecutionResultPlanProviderAlias(
  provider: string | undefined,
): provider is HermesBusinessPromptConfirmationTokenIssuanceExecutionResultPlanProviderAlias {
  return hermesBusinessPromptConfirmationTokenIssuanceExecutionResultPlanProviderAliases.includes(
    provider as HermesBusinessPromptConfirmationTokenIssuanceExecutionResultPlanProviderAlias,
  );
}

export const hermesBusinessPromptConfirmationTokenIssuanceExecutionResultAuditProviderAliases =
  [
...
export type HermesBusinessPromptConfirmationTokenIssuanceExecutionResultAuditProviderAlias =
  (typeof hermesBusinessPromptConfirmationTokenIssuanceExecutionResultAuditProviderAliases)[number];

export function isHermesBusinessPromptConfirmationTokenIssuanceExecutionResultAuditProviderAlias(
  provider: string | undefined,
): provider is HermesBusinessPromptConfirmationTokenIssuanceExecutionResultAuditProviderAlias {
  return hermesBusinessPromptConfirmationTokenIssuanceExecutionResultAuditProviderAliases.includes(
    provider as HermesBusinessPromptConfirmationTokenIssuanceExecutionResultAuditProviderAlias,
  );
}
