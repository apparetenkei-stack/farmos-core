...
} from './api_boundary/hermes_business_prompt_confirmation_token_issuance_readiness_boundary';
...
assert.equal(
  needsReview.confirmation_token_issuance_readiness_mode,
...
assert.equal(needsReview.confirmation_token_issuance_readiness_available, false);
assert.equal(needsReview.confirmation_token_issuance_readiness_label, 'none');
assert.equal(
  needsReview.confirmation_token_issuance_readiness_disabled_reason,
...
assert.equal(
  blocked.confirmation_token_issuance_readiness_disabled_reason,
  'blocked_by_policy',
);
assert.equal(blocked.confirmation_token_issuance_request_status, 'blocked_by_policy');
assert.equal(
...
assert.equal(
  notReady.confirmation_token_issuance_readiness_disabled_reason,
  'payload_not_ready',
);
assert.equal(notReady.confirmation_token_issuance_request_status, 'payload_not_ready');
assert.equal(
  ...
  JSON.stringify(
    {
      ...
      confirmation_token_issuance_readiness_available:
        needsReview.confirmation_token_issuance_readiness_available,
      confirmation_token_issuance_request_allowed:
        needsReview.confirmation_token_issuance_request_allowed,
      ...
      confirmation_token_plaintext_created:
        needsReview.confirmation_token_plaintext_created,
