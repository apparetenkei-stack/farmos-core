...
async function main() {
  ...
  assert.equal(result.switch.requested_provider, "business_prompt_human_confirmation");
  ...
  assert.equal(
    ...
    "business_prompt_human_confirmation_dry_run_only",
  );
  ...
  assert.equal(
    result.switch.business_prompt_human_confirmation_status.mode,
    "hermes_business_prompt_human_confirmation_boundary",
  );
  assert.equal(
    result.switch.business_prompt_human_confirmation_status.confirmation_mode,
    "dry_run_human_confirmation_only",
  );
  assert.equal(
    result.switch.business_prompt_human_confirmation_status.schema_version,
    "hermes.business_prompt_confirmation.v0",
  );
  assert.equal(
    result.switch.business_prompt_human_confirmation_status.payload_schema_version,
    "hermes.business_prompt_payload.v0",
  );
  assert.equal(
    result.switch.business_prompt_human_confirmation_status.payload_kind,
    "business_prompt_candidate",
  );
  assert.equal(
    result.switch.business_prompt_human_confirmation_status.payload_created,
    true,
  );
  assert.equal(
    result.switch.business_prompt_human_confirmation_status.payload_send_allowed,
    false,
  );
  assert.equal(
    result.switch.business_prompt_human_confirmation_status.confirmation_required,
    true,
  );
  assert.equal(
    result.switch.business_prompt_human_confirmation_status.human_confirmed,
    false,
  );
  assert.equal(
    result.switch.business_prompt_human_confirmation_status.confirmation_state,
    "required",
  );
  assert.equal(
    result.switch.business_prompt_human_confirmation_status.confirmation_result,
    "not_confirmed",
  );
  assert.equal(
    result.switch.business_prompt_human_confirmation_status
  ...
  assert.equal(
    result.switch.business_prompt_human_confirmation_status.raw_prompt_exposed,
    false,
  );
  assert.equal(
    result.switch.business_prompt_human_confirmation_status
  ...
  assert.equal(
    result.switch.business_prompt_human_confirmation_status.proposal_body_included,
    false,
  );
  assert.equal(
    result.switch.business_prompt_human_confirmation_status
  ...
  assert.equal(
    result.switch.business_prompt_human_confirmation_status.request_body_created,
    false,
  );
  assert.equal(
    result.switch.business_prompt_human_confirmation_status.request_body_sent,
    false,
  );
  assert.equal(
    result.switch.business_prompt_human_confirmation_status.prompt_sent,
    false,
  );
  assert.equal(
    result.switch.business_prompt_human_confirmation_status.selected_provider,
    "mock",
  );
  assert.equal(
    result.switch.business_prompt_human_confirmation_status.fallback_provider,
    "mock",
  );
  assert.equal(result.switch.business_prompt_human_confirmation_status.tokens_used, 0);
  ...
  assert.ok(localAlias.switch.business_prompt_human_confirmation_status);
    ...
    JSON.stringify(
      {
        result: "ok",
        checked:
          "hermes_llm_adapter_switch_business_prompt_human_confirmation_integration",
      },
      null,
      2,
    ),
